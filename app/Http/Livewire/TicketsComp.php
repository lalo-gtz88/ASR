...
class TicketsComp extends Component
{
    ...
    protected $queryString = ['search', 'userFilter', 'filtro_status'];
    protected $listeners = ['restore','delete'];
    ...
    public function render()
    {
        ...
        if(!$user->hasPermissionTo('Mostrar todos los tickets')){
            ...
            $this->dispatchBrowserEvent('disabledFiltro');
        }

        return view('livewire.tickets-comp', compact('tickets', 'totalTickets', 'ticketsByUser','actividades'));
    }
    ...
    public function copy($id)
    {
        ...
        $this->dispatchBrowserEvent('copied', ['descripcion'=> $this->descripcion]);
    }
    ...
    public function openModalMerge($id)
    {
        ...
        $this->dispatchBrowserEvent('openModalMerge');
    }
