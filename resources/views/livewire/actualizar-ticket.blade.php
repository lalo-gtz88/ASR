<div>
    ...
    <div class="d-flex flex-column">
        ...
        <select class="form-select" id="edificio" wire:model="edificio" wire:change="guardar()">
    ...
    <div class="d-flex flex-column">
        ...
        <select class="form-select" id="departamento" wire:model="departamento" wire:change="guardar()">
            <option value="">---Selecciona una opción---</option>
    ...
    <div class="d-flex flex-column">
        ...
        <select type="text" id="categoria" wire:model="categoria" class="form-select" wire:change="guardar()">
            <option value="">---Selecciona una opción---</option>
    ...
    <div class="d-flex flex-column">
        ...
        <select id="asignado" wire:model="asignado" class="form-select" wire:change="guardar()">
            <option value=""> ---Selecciona una opción--- </option>
    ...
    <div class="d-flex flex-column">
        ...
        <select id="prioridad" wire:model="prioridad" class="form-select" wire:change="guardar()">
            <option>Baja</option>
            <option>Media</option>
            <option>Alta</option>
        </select>
    ...
    <div>
        ...
        <select id="unidad" class="form-select field" wire:model="unidad" wire:change="guardar()">
            <option value=""> ---Selecciona una opción ---</option>
