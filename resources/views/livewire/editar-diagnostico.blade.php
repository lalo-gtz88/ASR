<div>
    ...
    <div class="container"><a href="{{ $urlPrev }}"><i class="fa fa-arrow-circle-left"></i> Atras</a></div>
    <!-- Modal para nuevos diagnosticos -->
    <div id="mod-nuevo-ticket" class="" data-backdrop="static" data-keyboard="false" wire:ignore.self>
        <div class="modal-dialog modal-lg  modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header  bg-secondary text-white ">
                    <h5 class="modal-title">Editar diagnóstico # {{$idDiagnostico}}</h5>
                </div>
                <div class="modal-body" wire:init="$set('readyToLoad', true)"  style="max-height:60vh;">
                    @if($readyToLoad)
                    <h6>SOLICITANTE</h6>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <input type="search" class="form-control" id="search" wire:model="search" wire:keyup="searchEquipo()" placeholder="Buscar DSI, Service Tag">
                        </div>
                    </div>
                    ...
                    <button class="btn btn-success mt-2 btn-sm" wire:click="agregar"><i class="fa fa-plus"></i> Agregar</button>
                    @error('noAgregados')
                    <br>
                    <small class="text-danger">{{$message}}</small>
                    @enderror
